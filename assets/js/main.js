...
function listaServisios() {
    fetch('assets/js/servicios.json')
        .then(res => res.json())
        .then(listaDeServicios => {
            servicioCard(listaDeServicios)
            listado = listaDeServicios;
        })
}
...
function servicioCard(servicio) {
    ...
    <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-20 wow fadeInUpBig" >
                        <div class="blog-content">
                            <h4 class="blog-title-servicio"><a>${servicio.servicio}.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                                <div class="author-content media-body">

                                    <p class="text-servicio">${servicio.descipcion}.</p>
                                </div>
                            </div>
                        </div>
                    </div> <!-- single blog -->
